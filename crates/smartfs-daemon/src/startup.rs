...
/// The `001`–`009` markers, derived from `migrations/0*.sql`.
pub const MIGRATION_MARKERS: [MigrationMarker; 9] = [
    ...
    MigrationMarker { id: "008", table: "inode_registry", column: Some("mtime") },
    MigrationMarker { id: "009", table: "blobs", column: Some("shared") },
];
